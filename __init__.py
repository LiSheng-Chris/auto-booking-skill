...
def get_args():
    ...
    parser.add_argument("--model", default="/opt/mycroft/skills/auto-booking-skill.lisdre/model_fullTrain.h5", type=str)  # subest indicator 500 face folder for subset
...
class AutoBooking(MycroftSkill):
    ...
    def handle_booking_auto(self, message):
        ...
        url = 'http://6476b39a8f7c.ngrok.io/bookingsystem'
        myobj = {
